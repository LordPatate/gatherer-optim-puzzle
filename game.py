...
#pygame.draw.rect(window, const.BLUE, pygame.Rect(0,0, const.WINDOW_W, const.WINDOW_H)
...
origin = ((const.WINDOW_W - const.HERO_W) / 2, (const.WINDOW_H - const.HERO_H) / 2)
hero = Hero(origin)
...
async def main():
    while True:
        ...
        pygame.draw.rect(window, const.WHITE, pygame.Rect(hero.pos, (const.HERO_W, const.HERO_H)))
        for item in world:
            pygame.draw.rect(window, const.WHITE, pygame.Rect(item.pos, (const.ITEM_W, const.ITEM_H)))
